                ...
                <div className={styles.container}>
                    <div className={styles.aboutLeft}>
                        <Image 
                          ...
                          />
                          <br></br>
                        <p>Part of my skills as Webbdeveloper is to get in deep with different programs to achieve my work.</p>
                        <Image 
                    ...
                    <div className={styles.aboutRight}>
                        <div className={styles.article}>
                            ...
                            <p>Hi!!!<br></br>Here you have a positive and creative person who try to get  
                            a place in this career. My head is always full of ideas.  
                            ...
                            of views.<br></br>
                            I am a mother of three children, soon teens so as you can imagine
                            eficency in time is a must to achive the dayly rutine.<br></br>
                        ...
                        <div className={styles.article}>
                            ...
                            <p>I can speak fluent English and Swedish but my mother tonge is Spanish, so you can count with 3 languages in your asset.
                            Photography is my passion and I frame my everyday looking for the perfect photo.
                            I love water and I feel like a marmaid when I am in it. Any kind of sport in water I am willing to try it. 
                            That is how kayak have come to my life, giving me the perfect photos and the pleasure of my free little time.
                            </p>
                        </div>
